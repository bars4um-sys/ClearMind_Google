        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="relative rounded-3xl overflow-hidden bg-[#2D2A26] border border-[#DDD4C4] shadow-lg">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                <span className="text-sm font-bold uppercase tracking-widest text-[#E5A882]">
                  АВТОР И ВЕДУЩАЯ КУРСА
                </span>
                <h3 className="text-2xl font-bold font-serif-heading text-[#FAF6ED]">
                  Мила Хабирова
                </h3>
                <p className="text-sm text-[#E0D5C1] mt-0.5">
            ...
            <div className="bg-[#FAF7F0] rounded-2xl p-6 border border-[#E2D6C5] shadow-xs">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-base font-serif italic text-[#443D34] leading-relaxed">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {stats.map((stat, idx) => (
                <div key={idx} className="bg-white rounded-2xl p-4 border border-[#E4DCCF] text-center shadow-xs">
                  ...
                  <div className="text-sm text-[#70685B] mt-1 leading-snug">
                    {stat.label}
                  </div>
                </div>
              ))}
            ...
            <div className="space-y-3 pt-2">
              <h4 className="text-sm font-bold uppercase tracking-wider text-[#736B5E]">
                Квалификация и профессиональный опыт:
              </h4>
              <ul className="space-y-2.5">
                {credentials.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-3 text-sm sm:text-base text-[#4E473D]">
