    ...
    <section id="faq" className="py-14 sm:py-20 bg-[#F4EFE6] border-t border-[#E5DEC F]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="mt-2 text-sm sm:text-base text-[#665E51]">
          ...
          {filteredItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="text-base sm:text-lg font-bold text-[#2A241E] font-serif-heading">
                    {item.question}
                  </span>
                ...
                {isOpen && (
                  <div className="px-5 pb-5 pt-1 text-sm sm:text-base text-[#5C5447] leading-relaxed border-t border-[#F0EAE0]">
                    {item.answer}
                  </div>
                )}
              </div>
        ...
        <div className="mt-10 bg-[#E8E0D2] rounded-2xl p-6 border border-[#DACFBD] text-center flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-left">
            ...
            <p className="text-sm text-[#6B6152] mt-0.5">
          ...
          <a
            ...
            className="bg-[#2D2A26] hover:bg-[#1A1816] text-[#F3EFE6] px-5 py-2.5 rounded-xl text-sm font-medium flex items-center gap-2 shrink-0 transition-colors"
          >
