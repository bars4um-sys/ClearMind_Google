    ...
    <section id="hero-section" className="pt-2 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-5 relative rounded-2xl sm:rounded-3xl overflow-hidden bg-[#38312B] text-white min-h-[460px] sm:min-h-[540px] lg:min-h-[580px] flex flex-col justify-between p-6 sm:p-8 shadow-xl">
          ...
          <div className="relative z-10 space-y-1">
            <p className="text-[11px] sm:text-xs font-semibold tracking-[0.2em] text-[#E8DCC8] uppercase font-sans">
              БОЛЬШЕ ЧЕМ ЯЗЫК.
            </p>
            <p className="text-[11px] sm:text-xs font-semibold tracking-[0.2em] text-[#E8DCC8] uppercase font-sans">
              ШИРЕ, ЧЕМ ПАМЯТЬ.
          ...
          <div className="relative z-10 space-y-1 my-auto self-start hidden md:block">
            {['English', 'Deutsch', 'Español', 'Français'].map((lang, idx) => (
              <div
                key={lang}
                className="bg-[#1F1C19]/70 backdrop-blur-sm text-[#E7DFD1] text-[11px] font-mono px-2.5 py-1 rounded border-l-2 border-[#A04F3F]"
          ...
          <div className="relative z-10 flex items-end justify-between pt-6 mt-auto">
            <div>
              ...
              <p className="text-[10px] sm:text-xs font-medium tracking-widest text-[#E0D5C1] uppercase mt-0.5">
                АВТОР КУРСА
              </p>
            </div>
            ...
            <div className="bg-[#FAF7F0] text-[#332E27] px-3.5 py-2 rounded-xl shadow-lg border border-[#E4DC C8] text-right">
              <div className="font-handwriting text-xs sm:text-sm text-[#4A4237] leading-tight flex items-center gap-1">
        ...
        <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 sm:py-9 border border-[#E8E2D5] shadow-sm flex flex-col justify-between flex-grow">
            <div>
              {/* Eyebrow badge */}
              <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#A04F3F] mb-3">
                <span className="w-2 h-2 rounded-full bg-[#A04F3F]" />
                <span>ОНЛАЙН-КУРС • 12 НЕДЕЛЬ • 45+</span>
              </div>

              {/* Main Headline */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[44px] xl:text-[50px] font-semibold text-[#24211E] leading-[1.12] tracking-tight font-serif-heading mb-4">
              ...
              {/* Lead paragraph */}
              <p className="text-base sm:text-lg text-[#554F45] leading-relaxed max-w-2xl mb-8">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-1">
                <button
                  ...
                  className="bg-[#A04F3F] hover:bg-[#8B3F31] active:scale-[0.98] text-white px-7 py-3.5 rounded-xl font-medium text-base sm:text-lg shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-3 cursor-pointer group"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-8 mt-6 border-t border-[#EBE5DA]">
              ...
              <div className="bg-[#F4EFE6] rounded-xl p-3.5 sm:p-4 border border-[#E5DEC F] flex items-start sm:flex-col sm:items-start gap-3">
                ...
                <div>
                  <h4 className="text-base sm:text-lg font-bold text-[#2A2621] font-serif-heading">
                    12 недель
                  </h4>
                  <p className="text-xs text-[#6B6356] leading-snug mt-0.5">
              ...
              <div className="bg-[#E4ECEE] rounded-xl p-3.5 sm:p-4 border border-[#D0DDE0] flex items-start sm:flex-col sm:items-start gap-3">
                ...
                <div>
                  <h4 className="text-base sm:text-lg font-bold text-[#202E32] font-serif-heading">
                    20–30 минут
                  </h4>
                  <p className="text-xs text-[#52666B] leading-snug mt-0.5">
              ...
              <div className="bg-[#E7EFE6] rounded-xl p-3.5 sm:p-4 border border-[#D5E2D4] flex items-start sm:flex-col sm:items-start gap-3">
                ...
                <div>
                  <h4 className="text-base sm:text-lg font-bold text-[#233324] font-serif-heading">
                    Без зубрёжки
                  </h4>
                  <p className="text-xs text-[#506853] leading-snug mt-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 mt-6">
        ...
        <div className="md:col-span-7 bg-[#E3EBEB] rounded-2xl p-6 sm:p-7 border border-[#D0DDDD] flex flex-col justify-between">
          <div className="flex gap-3">
            ...
            <p className="text-base sm:text-lg text-[#324548] font-serif italic leading-relaxed pt-1">
        ...
        <div className="md:col-span-5 bg-[#F2ECE1] rounded-2xl p-6 sm:p-7 border border-[#E3D8C8] flex flex-col justify-between relative overflow-hidden">
          <div className="relative z-10">
            <p className="text-xs font-semibold tracking-widest uppercase text-[#736858] mb-1">
              ЯЗЫК РАСШИРЯЕТ МИР.
            </p>
            <p className="text-xs font-semibold tracking-widest uppercase text-[#736858]">
              А ЯСНЫЙ УМ ПОМОГАЕТ В НЁМ ЖИТЬ.
            </p>
            <div className="w-8 h-[1px] bg-[#A04F3F]/40 my-2.5" />
          </div>
          <div className="relative z-10 text-right">
            <span className="font-handwriting text-base sm:text-lg text-[#884638]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-6">
        ...
        <div className="lg:col-span-6 bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-7 border border-[#E8E2D5] shadow-sm">
          <h4 className="text-xs font-bold uppercase tracking-wider text-[#7A7265] mb-5">
            ЧТО ИЗМЕНИТСЯ ЧЕРЕЗ 12 НЕДЕЛЬ
          </h4>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {/* 01 */}
            <div className="flex sm:flex-col gap-3">
              <span className="w-8 h-8 rounded-full bg-[#F4EDE2] text-[#8E4A3B] font-mono text-xs font-bold flex items-center justify-center shrink-0">
                01
              </span>
              <div>
                ...
                <p className="text-xs text-[#736C60] mt-0.5">
        ...
        <div className="lg:col-span-6 bg-white/80 backdrop-blur-sm rounded-2xl p-6 sm:p-7 border border-[#E8E2D5] shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[11px] font-medium text-[#A04F3F] bg-[#F7ECE9] px-2 py-0.5 rounded-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
            ...
            <div className="flex items-start gap-3 bg-[#FAF7F2] p-3 rounded-xl border border-[#ECE4D8]">
              ...
              <div>
                <h5 className="text-sm font-bold text-[#2A2621] font-serif-heading">Память</h5>
                <p className="text-[11px] text-[#736C60] leading-tight mt-0.5">
            ...
            <div className="flex items-start gap-3 bg-[#FAF7F2] p-3 rounded-xl border border-[#ECE4D8]">
              ...
              <div>
                <h5 className="text-sm font-bold text-[#202E32] font-serif-heading">Внимание</h5>
                <p className="text-[11px] text-[#5A6D72] leading-tight mt-0.5">
            ...
            <div className="flex items-start gap-3 bg-[#FAF7F2] p-3 rounded-xl border border-[#ECE4D8]">
              ...
              <div>
                <h5 className="text-sm font-bold text-[#233324] font-serif-heading">Язык</h5>
                <p className="text-[11px] text-[#556957] leading-tight mt-0.5">
