        ...
        <div className="flex justify-center mb-12">
          <div className="bg-[#E5DDD0] p-1 rounded-xl inline-flex items-center gap-1 border border-[#D8CEBF]">
            <button
              ...
              className={`px-4 sm:px-6 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all cursor-pointer ${
                paymentMode === 'full'
            ...
            <button
              ...
              className={`px-4 sm:px-6 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all cursor-pointer flex items-center gap-1.5 ${
                paymentMode === 'split'
                  ? 'bg-white text-[#24211E] shadow-xs'
                  : 'text-[#635B4E] hover:text-[#24211E]'
              }`}
            >
              ...
              <span className="bg-[#A04F3F] text-white text-[10px] px-1.5 py-0.2 rounded font-bold">
                от 2 490 ₽/мес
              </span>
            </button>
          </div>
          ...
          {TARIFF_PLANS.map((plan) => {
            ...
            return (
              ...
              >
                {/* Popular Badge */}
                {plan.badge && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#A04F3F] text-white text-[11px] font-bold uppercase tracking-wider px-3.5 py-1 rounded-full shadow-xs">
                    {plan.badge}
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-[#6E6557] mt-1 leading-relaxed min-h-[36px]">
                      {plan.description}
                    </p>
                  </div>
                    ...
                    {paymentMode === 'full' ? (
                      <div>
                        <div className="flex items-baseline gap-2">
                          ...
                          <span className="text-xs sm:text-sm text-[#8C8375] line-through">
                            {plan.originalPrice.toLocaleString('ru-RU')} ₽
                          </span>
                        </div>
                        <span className="text-[11px] text-[#527056] font-semibold mt-0.5 block">
                      ...
                      <div>
                        <div className="flex items-baseline gap-1.5">
                          ...
                          <span className="text-xs text-[#736A5D]">/ месяц</span>
                        </div>
                        <span className="text-[11px] text-[#736A5D] mt-0.5 block">
                  ...
                  {/* Places counter */}
                  <div className="flex items-center gap-1.5 text-xs text-[#8E4A3B] font-medium mb-5">
                  ...
                  <div className="space-y-3 mb-8">
                    <span className="text-[11px] font-bold text-[#7A7163] uppercase tracking-wider block">
                      Что входит в тариф:
                    </span>
                ...
                <div>
                  ...
                  <p className="text-[11px] text-center text-[#7F7668] mt-2.5">
        ...
        <div className="mt-12 bg-white rounded-2xl p-6 sm:p-8 border border-[#E0D6C5] flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xs">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#615A4F] mt-1 leading-relaxed max-w-2xl">
          ...
          <div className="text-xs text-[#7A7163] text-center sm:text-right shrink-0">
